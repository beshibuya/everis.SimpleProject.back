...
namespace everis.SimpleProject.Data.EF.Migrations
{
    ...
    [Migration("20190207195208_Projeto_Siglas")]
    partial class Projeto_Siglas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.Exts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.ProjetoSigla", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.ProjetoTipoDemanda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.TipoDemanda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.Projeto", b =>
                {
                    ...
                    b.HasOne("everis.SimpleProject.Domain.Models.Exts", "Ext")
                        .WithMany()
                        .HasForeignKey("ExtId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("everis.SimpleProject.Domain.Models.ProjetoTipoDemanda", b =>
                {
                    ...
                    b.HasOne("everis.SimpleProject.Domain.Models.TipoDemanda", "TipoDemanda")
                        .WithMany()
